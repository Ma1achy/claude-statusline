...
export interface SessionState {
  ...
  git?: { cwd: string; ts: number; data: Record<string, string> };   // background git-refresh cache
  lastGitRefresh?: number;         // ts of the last background git refresh kicked (rate-limit)
}
